...
public class DemoQrCodePaypal {
	public static void main(String[] args) throws IOException, DecoderException {
		...
		httpConn.setRequestProperty("Authorization", "Bearer A21AAIV_ec1kdGtFaoBVv5SXKobbkTGXykwe8XSNkpn7w0ZkqGW7eRlsYrYahkRJ1nqM1v_OOTLTdWsCdkNiFTsjuc2Vx-G0w");
		...
		httpConnSend.setRequestProperty("Authorization", "Bearer A21AAIV_ec1kdGtFaoBVv5SXKobbkTGXykwe8XSNkpn7w0ZkqGW7eRlsYrYahkRJ1nqM1v_OOTLTdWsCdkNiFTsjuc2Vx-G0w");
		...
		System.out.println("Response Send " + responseSend);
		...
		httpConnQR.setRequestProperty("Authorization", "Bearer ");
