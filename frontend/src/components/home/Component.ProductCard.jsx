    ...
    return (
        <div className="h-full w-full flex">
            {productData.map((product) => (
                <div
                    className="w-1/5 h-full bg-white rounded-lg homepage-card-item ml-2 mr-2 overflow-hidden transition-transform transform hover:scale-105 hover:transition-transform hover:duration-500 hover:homepage-card-item"
                    key={product.id}
                >
