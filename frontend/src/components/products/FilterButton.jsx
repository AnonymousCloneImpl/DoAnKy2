        ...
        <>
          <div className="h-10 w-24 mr-5 relative left-0 mt-2">
            ...
            {showCpuOption ? (
              ...
              <button onClick={handleCpuClick}
                ...
                className={`h-full w-full rounded-md overflow-hidden ${cpuSelect ? 'text-red-600 border-2 border-red-600 bg-red-100' : 'bg-gray-200 hover:bg-gray-400'
          ...
          <div className="h-10 w-24 relative mr-5 mt-2">
            ...
            {showRamOption ? (
              ...
              <button onClick={handleRamClick}
                className={`h-full buttonNonColor w-full rounded-md overflow-hidden ${ramSelect ? 'text-red-600 border-2 border-red-600 bg-red-100' : 'bg-gray-200 hover:bg-gray-400'
                  } flex justify-center items-center`}
              >
                <FontAwesomeIcon className="w-2/6 ml-2" icon={faMemory} />
                <p className="h-full w-4/6 ml-1 flex items-center">
          ...
          <div className="h-10 w-24 relative mt-2">
            ...
            {showDisplayOption ? (
              ...
              <button onClick={handleDisplayClick}
                className={`h-full rounded-md overflow-hidden ${displaySelect ? 'text-red-600 border-2 border-red-600 bg-red-100' : 'bg-gray-200 hover:bg-gray-400'
                  } flex justify-center items-center`}
              >
                <FontAwesomeIcon className="ml-2" icon={faDisplay} />
            ...
            <>
              <div className="h-10 w-24 mt-2">
                ...
                {showConnectionOption ? (
                  ...
                  <button onClick={handleConnectionClick}
                    className={`h-full rounded-md overflow-hidden ${connectionSelect ? 'text-red-600 border-2 border-red-600 bg-red-100' : 'bg-gray-200 hover:bg-gray-400'
                      } flex justify-center items-center`}
                  >
                    <FontAwesomeIcon className="ml-2" icon={faDisplay} />
                    <p className="h-full ml-1 flex items-center">
