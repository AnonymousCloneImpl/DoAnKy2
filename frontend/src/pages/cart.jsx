        ...
        <div className="flex shadow-md my-10">
          <div className="w-3/4 bg-white px-10 py-10">
            ...
            <div className="flex mt-10 mb-5">
              ...
              <h3 className="font-semibold text-center text-gray-600 text-base uppercase w-1/5 text-center">Quantity</h3>
              <h3 className="font-semibold text-center text-gray-600 text-base uppercase w-1/5 text-center">Price</h3>
              <h3 className="font-semibold text-center text-gray-600 text-base uppercase w-1/5 text-center">Total</h3>
            </div>
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div key={index} className="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <span className="text-red-500 text-sm">{item.producer}</span>
